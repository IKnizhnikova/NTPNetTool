...
import ru.mathtech.npntool.editor.policies.NPNDiagramSNXYLayoutPolicy;
import ru.mathtech.npntool.npnets.npndiagrams.NPNDiagramNetSystem;



public class NPNDiagramNetSystemEditPart extends AbstractGraphicalEditPart {
	...
	public NPNDiagramNetSystemEditPart() {
		super();
	...
	protected void createEditPolicies() {
		installEditPolicy(EditPolicy.LAYOUT_ROLE, new NPNDiagramSNXYLayoutPolicy());
